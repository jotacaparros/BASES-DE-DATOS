...
CREATE TABLE `gusta` (
  ...
  CONSTRAINT `gusta_ibfk_1` FOREIGN KEY (`nom_usuario_1`) REFERENCES `usuario` (`nom_usuario`),
  CONSTRAINT `gusta_ibfk_2` FOREIGN KEY (`nom_usuario_2`) REFERENCES `usuario` (`nom_usuario`)
...
-- Dump completed on 2022-03-04 12:30:57
