...
CREATE TABLE `practica` (
  ...
  KEY `practica_fk_2` (`aficion`),
  CONSTRAINT `practica_fk_1` FOREIGN KEY (`nom_usuario`) REFERENCES `usuario` (`nom_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `practica_fk_2` FOREIGN KEY (`aficion`) REFERENCES `aficion` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
